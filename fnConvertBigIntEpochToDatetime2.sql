...
set @epochms = 1745098816792 --2025-04-19 23:40:16.793

--input is epoch in milliseconds as string
select dbo.fnConvertBigIntEpochToDatetime2(@epochms, @SQLTimeZone)
*/
create or alter function dbo.fnConvertBigIntEpochToDatetime2(@epochms bigint, @SQLTimezone varchar(2048) = 'UTC' )
returns datetime2(3)
as
begin
...
set @ms = convert(int, @epochms % 1000)
set @epoch = convert(int, @epochms / 1000)
